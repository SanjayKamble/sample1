...
function Customizer() {
  ...
  return (
    <li className="relative">
      ...
      <div
        className={classNames("fixed w-full h-full inset-0 z-50 ", {
          "hidden ": !open,
        })}
        id="mobile-canvas"
      >
        ...
        <nav
          ref={ref}
          id="mobile-nav"
          className="transition flex flex-col ltr:right-0 rtl:left-0 w-72 fixed top-0 bg-white dark:bg-gray-800 h-full overflow-auto z-40 scrollbars show"
          role="menu"
